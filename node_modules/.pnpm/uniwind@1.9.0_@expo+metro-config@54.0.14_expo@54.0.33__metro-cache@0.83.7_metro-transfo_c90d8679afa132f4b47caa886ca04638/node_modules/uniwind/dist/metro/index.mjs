import { U as UniwindBundlerConfig, P as Platform } from '../shared/uniwind.WHb-3yIn.mjs';
...
const isUniwindRequest = (moduleName) => moduleName === "uniwind" || moduleName.startsWith("uniwind/");
